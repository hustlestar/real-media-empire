...
from pipelines.steps.video_steps import generate_quotes_video
from pipelines.steps.publish_steps import create_video_meta
...
def generate_quotes_video_pipeline(generate_quotes_video, create_video_meta):
    video_file_path, text_script = generate_quotes_video()
...
def main(click_context, execution_date: str, channel_config_path, author, number_of_videos, is_split_quote, recover, other_args):
    ...
    pipeline = generate_quotes_video_pipeline(generate_quotes_video(pipeline_params), create_video_meta(pipeline_params))
