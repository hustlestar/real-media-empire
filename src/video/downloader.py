                ...
                if video:
                    ...
                    if video_files:
                        ...
                        if 'mp4' in file_type:
                            ...
                            is_downloaded = download_video(video_url, result_filename, self.download_dir)
                            if is_downloaded:
...
if __name__ == '__main__':
    ...
    PexelsDownloadTask(query="thriving", download_dir=CONFIG.get('DOWNLOAD_DIR'), number_of_downloads=100).run()
