"""Basic tests for pdf-link-youtube-to-anything-tg-bot."""
...
class TestPdfLinkYoutubeToAnythingTgBot:
    ...
    def test_config_loading(self):
        ...
        config = BotConfig(
            ...
            bot_name="pdf-link-youtube-to-anything-tg-bot",
            default_language="en",
            supported_languages="en,ru,es"
        )
        assert config.bot_token == "test_token"
        assert config.bot_name == "pdf-link-youtube-to-anything-tg-bot"
